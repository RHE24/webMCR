...
getDB()->ask(DB_TOUSERS."ADD `{$bd_users['female']}` tinyint(1) NOT NULL DEFAULT '2';");
getDB()->ask(DB_TOUSERS."ADD `{$bd_users['email']}` varchar(50) DEFAULT NULL;");
...
getDB()->ask(DB_TOUSERS."ADD `{$bd_users['ctime']}` datetime NOT NULL DEFAULT '0000-00-00 00:00:00';");
